...
class sc2n extends sc
{
    public function generate($answer, $params)
    {
        ...
        //     LEFT JOIN `sites` ON `sites`.`id`=`m_model_to_sites`.`site_id`
        //     WHERE `m_model_to_sites`.`site_id`= ? 
        //     AND `sites` not in ()
        //     GROUP BY `model_types`.`name`";
        ...
        if(!empty($params['region_name'])){
            $this->_datas['region_name'] = $params['region_name'];
        }
        if(!empty($params['validatedCity'])){
            $this->_datas['validatedCity'] = $params['validatedCity'];
        }
        ...
        if (isset($params['static']))
        {
            ...
            if (!empty($params['indexSite']) && $params['static'] == '/')  $file_name ='indexSite';
    ...
    {
        $this->_datas['showcase'] = $urls = array(
            "acer" => array('phones','laptop','tablets','computers'),
            "apple" => array('phones','laptop','tablets','computers'),
            "asus" => array('phones','laptop','tablets','computers'),
            "canon" => array('foto','all-in-one','printers'),
            "dell" => array('laptop','tablets','desctops','computers','servers'),
            "hp" => array('laptop','tablets','computers','desctops','printers','all-in-one'),
            "lenovo" => array('phones','laptop','tablets','computers','desctops','servers'),
            "msi" => array('laptop','tablets','computers',),
            "htc" => array('phones','tablets',),
            "huawei" => array('phones','tablets',),
            "nikon" => array('foto'),
            "samsung" => array('phones','laptop','tablets','computers'),
            "sony" => array('phones','laptop','tablets','computers','consoles','photo_video'),
            "xiaomi" => array('phones','laptop','tablets','tv','projector'),
            "nokia" => array('phones','tablets'),
            "lg" => array('phones','laptop','tablets',),
            "meizu" => array('phones',),
            "toshiba" => array('laptop','tablets'),   
        );
        ...
        $this->_datas['add_device_type'] = $add_device_type = array(
            ...
            'phones' => array('type' => 'смартфон', 'type_rm' => 'смартфонов', 'type_m' => 'смартфоны'),
            'projector' => array('type' => 'проектор', 'type_rm' => 'проекторов', 'type_m' => 'проекторы'),
//            'monitor'=> array('type' => 'монитор', 'type_rm' => 'мониторов', 'type_m' => 'мониторы'),
//            'routers' => array('type' => 'роутер', 'type_rm' => 'роутеров', 'type_m' => 'роутеры'),
//            'bread_maker' => array('type' => 'хлебопечка', 'type_rm' => 'хлебопечек', 'type_m' => 'хлебопечеки'),
//            'fridge' => array('type' => 'холодильник', 'type_rm' => 'холодильников', 'type_m' => 'холодильники'),
//            'sewing_machine' => array('type' => 'швейная машина', 'type_rm' => 'швейных машин', 'type_m' => 'швейные машины'),
//            'electric_cooker' => array('type' => 'электрическая плита', 'type_rm' => 'электрических плит', 'type_m' => 'электрические плиты'),
//            'electric_scooter' => array('type' => 'электросамокат', 'type_rm' => 'электросамокатов', 'type_m' => 'электросамокаты'),
//            'electric_mop' => array('type' => 'электрошвабра', 'type_rm' => 'электрошвабр', 'type_m' => 'электрошвабры'),
//            'headphones' => array('type' => 'наушники', 'type_rm' => 'наушников', 'type_m' => 'наушники'),
//            'video_card' => array('type' => 'видеокарта', 'type_rm' => 'видеокарт', 'type_m' => 'видеокарты'),
//            'motherboard' => array('type' => 'материнская плата', 'type_rm' => 'материнских плат', 'type_m' => 'материнские платы'),
//            'watch' => array('type' => 'часы', 'type_rm' => 'часов', 'type_m' => 'часы'),
//            'smart_watches' => array('type' => 'смарт-часы', 'type_rm' => 'смарта-часов', 'type_m' => 'смарт-часы'),
//            'lens' => array('type' => 'объектив', 'type_rm' => 'объективов', 'type_m' => 'объективы'),
//            'quadcopter' => array('type' => 'квадрокоптер', 'type_rm' => 'квадрокоптеров', 'type_m' => 'квадрокоптеры'),
//            'self-balancing_scooters' => array('type' => 'гироскутер', 'type_rm' => 'гироскутеров', 'type_m' => 'гироскутеры'),
//            'plotter' => array('type' => 'плоттер', 'type_rm' => 'плоттеров', 'type_m' => 'плоттеры'),
//            'home_cinema' => array('type' => 'домашний кинотеатр', 'type_rm' => 'домашних кинотеатров', 'type_m' => 'домашние кинотеатры'),
//            'massage_chair' => array('type' => 'массажное кресло', 'type_rm' => 'массажных кресел', 'type_m' => 'массажные кресла'),
//            'miner' => array('type' => 'майнер', 'type_rm' => 'майнеров', 'type_m' => 'майнеры'),
//            'monocycle' => array('type' => 'моноколесо', 'type_rm' => 'моноколёс', 'type_m' => 'моноколёса'),
//            'segway' => array('type' => 'сегвей', 'type_rm' => 'сегвеев', 'type_m' => 'сегвеи'),
//            'sorter_banknotes' => array('type' => 'сортировщик купюр', 'type_rm' => 'сортировщиков купюр', 'type_m' => 'сортировщики купюр'),
//            'washing_machine' => array('type' => 'стиральная машина', 'type_rm' => 'стиральных машин', 'type_m' => 'стиральные машины'),
//            'vacuum_cleaner' => array('type' => 'пылесос', 'type_rm' => 'пылесосов', 'type_m' => 'пылесосы'),
//            'conditioner' => array('type' => 'кондиционер', 'type_rm' => 'кондиционеров', 'type_m' => 'кондиционеры'),
//            'range_hood' => array('type' => 'вытяжка', 'type_rm' => 'вытяжек', 'type_m' => 'вытяжки'),
//            'dishwasher' => array('type' => 'посудомоечная машина', 'type_rm' => 'посудомоечных машин', 'type_m' => 'посудомоечные машины'),
//            'coffee_machine' => array('type' => 'кофемашина', 'type_rm' => 'кофемашин', 'type_m' => 'кофемашины'),
//            'water_heater' => array('type' => 'водонагреватель', 'type_rm' => 'водонагревателей', 'type_m' => 'водонагреватели'),
//            'oven' => array('type' => 'духовой шкаф', 'type_rm' => 'духовых шкафов', 'type_m' => 'духовые шкафы'),
//            'robot_vacuum_cleaner' => array('type' => 'робот-пылесос', 'type_rm' => 'роботов-пылесосов', 'type_m' => 'роботы-пылесосы'),
//            'cooking_panel' => array('type' => 'варочная панель', 'type_rm' => 'варочных панелей', 'type_m' => 'варочные панели'),
//            'microwave' => array('type' => 'микроволновая печь', 'type_rm' => 'микроволновых печей', 'type_m' => 'микроволновые печи'),
//            'freezer' => array('type' => 'морозильная камера', 'type_rm' => 'морозильных камер', 'type_m' => 'морозильные камеры'),
//            'kitchen_machine' => array('type' => 'кухонный комбайн', 'type_rm' => 'кухонных комбайнов', 'type_m' => 'кухонные комбайны'),
//            'drying_machine' => array('type' => 'сушильная машина', 'type_rm' => 'сушильных машин', 'type_m' => 'сушильные машины'),
//            'industrial_refrigerator' => array('type' => 'промышленный холодильник', 'type_rm' => 'промышленных холодильников', 'type_m' => 'промышленные холодильники'),
        );
        
        
        // #rat код ниже для получения контента из движка Влада
        
        /*$ch = curl_init("https://gc.cibacrm.com/api?method=get_types&brand=hp");
        ...
        $getData =  json_decode(file_get_contents("https://gc.cibacrm.com/api?method=get_types&brand={$marka_lower}&api_key=qoWJBPnXpkbiiEQgFJIHxFa0z2KcOL4flbysj1Jx1xTmZcoECx3bVKLRfohxJHBI"), true);
        ...
        $synonyms = [
            ...
            'Компьютер' => 'desctops',
            'Сервер' => 'servers',
            'Игровая приставка' => 'consoles',
            'Видеокамера' => 'photo_video',
            'Телевизор' => 'tv',
            'Ноутбук' => 'laptop',
            'Планшет'=> 'tablets',
            'Смартфон' => 'phones',
        ...
        foreach ($getData['response'] as $type){
           //foreach ($value as $type){
                if(in_array($type['name'],$limitation)){
                    if($type['name']=='Сервер' && !in_array($marka_lower,['сisco', 'ibm', 'oracle', 'intel', 'inspur', 'supermicro', 'nec', 'huawei', 'hp', 'lenovo', 'dell','acer'])){
                        continue;
                    }
                    if(!empty($synonyms[$type['name']])){
                        $arrayBtendToType[$marka_lower][] = $synonyms[$type['name']];
                        if($type['name'] =='МФУ'){
                            $dictionary[$synonyms[$type['name']]] =['type' => 'МФУ','type_rm' => 'МФУ','type_m' => 'МФУ',];
                        }elseif($type['name'] =='Видеокамера'){
                            $dictionary[$synonyms[$type['name']]] =['type' => 'камера','type_rm' => 'камер','type_m' => 'камеры',];
                        }elseif($type['name'] =='Игровая приставка'){
                             $dictionary[$synonyms[$type['name']]] =['type' => 'приставка','type_rm' => 'приставок','type_m' => 'приставки',];
                        }else{
                            $dictionary[$synonyms[$type['name']]] =['type' => mb_strtolower($type['dic']['name_i']),'type_rm' => mb_strtolower($type['dic']['name_rm']),'type_m' => mb_strtolower($type['dic']['name_im']),];
                        }
                    }else {
                        //  $tempArray = explode('-',$type['code']);
                        //  $arrayBtendToType[$marka_lower][] = implode('_',$tempArray);
                        $arrayBtendToType[$marka_lower][] = $type['code'];
                        $dictionary[$type['code']] =['type' => mb_strtolower($type['dic']['name_i']),'type_rm' => mb_strtolower($type['dic']['name_rm']),'type_m' => mb_strtolower($type['dic']['name_im']),];
                    }
                    foreach($type['dic'] as $k => $v){
                        if($v !='МФУ'){
                            $type['dic'][$k] = mb_strtolower($v);
                        }
                    }
                }
                // $dictionary[$type['code']] =['type' => $type['dic']['name_i'],'type_rm' => $type['dic']['name_rm'],'type_m' => $type['dic']['name_r'],];
            //}
        }
        
        
        if (isset($arrayBtendToType[$marka_lower]))
        {
            $t = array();
            foreach ($arrayBtendToType[$marka_lower] as $url)
                $t[] = $dictionary[$url];
            //print_r($t);
            $this->_datas['left_menu_type'] =  $t;
            //print_r($this->_datas['all_devices']);
        }

        $arrayBtendToType10[$marka_lower] = array_slice($arrayBtendToType[$marka_lower],0,10);
        $this->_datas['typeList'] = array_slice($arrayBtendToType[$marka_lower],10);
        
        $this->_datas['add_device_type'] = $add_device_type =$dictionary;
        
        $this->_datas['showcase'] = $urls = $arrayBtendToType10;
        
        // #rat код выше для получения контента из движка Влада
        ...
        if (isset($urls[$marka_lower]))
        {
            ...
            //print_r($t);
            $this->_datas['all_devices'] =  $t;
            //print_r($this->_datas['all_devices']);
        }
        
        $myTypeToBrand = [
                'Polaris' => array(
                            'electric-scooter' => array('type' => 'электросамокат','type_rm' => 'электросамокатов', 'type_m' => 'электросамокаты'),
                            'hoverboard' => array('type' => 'гироскутер','type_rm' => 'гироскутеров','type_m' => 'гироскутеры'),
            ),
                'Razor' => array(
                            'electric-scooter' => array('type' => 'электросамокат','type_rm' => 'электросамокатов', 'type_m' => 'электросамокаты'),
                            'hoverboard' => array('type' => 'гироскутер','type_rm' => 'гироскутеров','type_m' => 'гироскутеры'),
                ...
                'optoma' => array(
                            'projector' => array('type' => 'проектор','type_rm' => 'проекторов', 'type_m' => 'проекторыы'),
            ),
                'Infocus' => array(
                            'projector' => array('type' => 'проектор','type_rm' => 'проекторов', 'type_m' => 'проекторыы'),
            ),
                ...
                'leica' => array(
                            'fotoapparaty' => array('type' => 'фотоаппарат','type_rm' => 'фотоаппаратов', 'type_m' => 'фотоаппараты'),
            ),
                'olympus' => array(
                            'fotoapparaty' => array('type' => 'фотоаппарат','type_rm' => 'фотоаппаратов', 'type_m' => 'фотоаппараты'),
            ),
                ...
                'nec' => array(
                            'server' => array('type' => 'сервер','type_rm' => 'серверов', 'type_m' => 'серверы'),
                            'monitor' => array('type' => 'монитор','type_rm' => 'мониторов', 'type_m' => 'мониторы'),
                            'projector' => array('type' => 'проектор','type_rm' => 'проекторов', 'type_m' => 'проекторы'),
                            'tv' => array('type' => 'телевизор','type_rm' => 'телевизоров', 'type_m' => 'телевизоры'),
            ),                   
        ];
        $myTypeToBrand = array_change_key_case($myTypeToBrand,CASE_LOWER);
        $brandName = lcfirst($this->_datas['marka']['name']);
        if (array_key_exists($brandName,$myTypeToBrand)){
            $this->_datas['add_device_type'] = $this->_datas['left_menu_type'] = $this->_datas['all_devices'] = $myTypeToBrand[$brandName];
                $this->_datas['accord']= [];
            foreach ($myTypeToBrand[$brandName] as $key => $val) {
                $this->_datas['accord'][$val['type']] = $key;
            }
        ...
        $this->_datas['accord_image'] = array(
            ...
            'монитор'=>'monitori',
            'роутер' =>'routers',
            'хлебопечка' =>'bread_maker',
            'холодильник' =>'fridge',
            'швейная машина' =>'sewing_machine',
            'электрическая плита' =>'electric_cooker',
            'электросамокат' =>'electric_scooter',
            'электрошвабра' =>'electric_mop',
            'наушники' =>'headphones',
            'видеокарта' =>'video_card',
            'материнская плата' =>'motherboard',
            'наручные часы' =>'watch',
            'смарт-часы' =>'smart_watches',
            'объектив' =>'lens',
            'квадрокоптер' =>'quadcopter',
            'гироскутер' =>'self-balancing_scooters',
            'плоттер' =>'plotter',
            'домашний кинотеатр' =>'home_cinema',
            'массажное кресло' =>'massage_chair',
            'майнер' =>'miner',
            'моноколесо' =>'monowheel',
            'сегвей' =>'segway',
            'сортировщик купюр' =>'sorter_banknotes',
            ...
            'духовой шкаф' =>'oven',
            'робот-пылесос' =>'robot_vacuum_cleaner',
            'варочная панель' =>'cooking_panel',
            'микроволновая печь' =>'microwave',
            'морозильная камера' =>'freezer',
            'кухонный комбайн' =>'kitchen_machine',
            'сушильная машина' =>'drying_machine',
            'лазерный принтер' =>'laser_printer',
            'струйный принтер' =>'jet_printer',
            'промышленный холодильник' =>'industrial_refrigerator',
        );
    }
}
