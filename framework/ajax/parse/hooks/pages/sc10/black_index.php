...
<html>
    ...
    <body>
        <header>
            <div class="inner">
                <div class="logo-wrapper">
                    ...
                    <p class="small">Ремонт важной техники</p>
                </div>
                <div class="phone">
        ...
        <div class="firstscreen padding">
            <div class="inner">
                 ...
                 <div class="first-title">
                    <h1>
                        Лаборатория<br>ремонта<br>
                    </h1>
                    <p>
                        Мы позаботимся о вашей технике.<br>Бережно. Педантично. Скрупулёзно.
                    </p>
                    <div class="button">
            ...
            <div class="inner">
                ...
                <?  $i = 0;           
                    ...
                    function setDays($val){
                        $default = $val;
                        $val = $val % 10;
                        if ($val == 1 && $default%100 !=11) return $default.' день';
                        if ($val == 2 &&  $val <=4 && $default <=4) return $default.' дня';
                        return $default.' дней';
                    }
                    function setMinuts($val){
                        $default = $val;
                        $val = $val % 10;
                        if ($val == 1 && $default%100 !=11) return $default.' минута';
                        if ($val == 2 &&  $val <=4 && $default <=4) return $default.' минуты';
                        return $default.' минут';
                    }                
                                 ...
                                 if (isset($services[$lower]))
                                 {
                                     foreach ($services[$lower] as $service)
                                     {
                                         ...
                                         if ($time >= 90 && $time <=1440) {
                                            $hours = floor($time / 60);
                                            $minutes = $time % 60;
                                            $count = setHours($hours).' '.setMinuts($minutes);
                                            if ($hours && $minutes !=0) $count = setHours($hours).' '.setMinuts($minutes); 
                                            else  $count = setHours($hours); 
                                         }
                                         if ($time >= 1440) {
                                            $days = intval($time / 1440);
                                            $hours = intval(($time-$days * 1440) / 60);
                                            $minutes = $time - ($days*1440 + $hours*60);
                                            if ($hours && $minutes !=0) $count = setDays($days).' '.setHours($hours).' '.setMinuts($minutes); 
                                            else  $count = setDays($days);                                      
                                         }
                                         if ($time <90) $count = setMinuts($service['min_time']);
                ...
                <div class="block-wrapper">
                    ...
                    <div class="left-side">
                        ...
                        <div class="block" style="width: 60%;">
                            <h3>Честные цены</h3>
                            <p>Мы не обманываем: не устанавливаем б/у комплектующие и не придумываем лишние услуги. Все работы проводятся ТОЛЬКО после согласования с владельцем точных сроков и полной стоимости.</p>
                        </div>
                    ...
                    <div class="right-side">
                        ...
                        <div class="block" style="width: 60%;">
                            ...
                            <p>Сразу после передачи устройства в диагностику вам выделяется персональный менеджер, который будет контролировать ход выполнения ремонта и постоянно держать вас в курсе всех изменений статуса аппарата.</p>
                        </div>
        ...
        <div id="policy" class="popup-form-2 padding">
            <p class="privacy">Соглашение на обработку персональных данных на сайте <a href="#" class="privacy-text-a">https://<?=$this->_datas['site_name']?>/</a></p>
            <p>
                Присоединяясь к настоящему Соглашению и оставляя свои данные на сайте https://<?=$this->_datas['site_name']?>/ (далее — Сайт), путём заполнения полей форм Пользователь:<br>
                ...
                <br>
                Пользователь, предоставляет https://<?=$this->_datas['site_name']?>/ право осуществлять следующие действия (операции) с персональными данными: сбор и накопление; хранение в течение установленных нормативными документами сроков хранения отчётности, но не менее трёх лет, с момента даты прекращения пользования услуг Пользователем; уточнение (обновление, изменение); использование; уничтожение; обезличивание; передача по требованию суда, в т. ч., третьим лицам, с соблюдением мер, обеспечивающих защиту персональных данных от несанкционированного доступа.<br>
