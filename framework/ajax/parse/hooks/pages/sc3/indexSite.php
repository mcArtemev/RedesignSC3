...
$brands = ["Acer", "Apple", "Asus", "Dell", "HP", "HTC", "Huawei", "Lenovo", "Meizu", "Samsung", "Sony", "Toshiba", "Xiaomi"];
...
$banner[1][] = array("смартфонов","планшетов","ноутбуков");
$banner[1][] = array("смартфонов","планшетов","ноутбуков");
...
$banner_dob[1][] = array("Acer","Apple","Asus","Dell","HP","HTC","Huawei","Lenovo","Meizu","Samsung","Sony","Toshiba","Xiaomi");
$banner_dob[1][] = array("Acer","Apple","Asus","Dell","HP","HTC","Huawei","Lenovo","Meizu","Samsung","Sony","Toshiba","Xiaomi");
...
<div class="imagerow">
    <div class="container">
        <div class="imagerel" style="height: 100%;"><img src="/templates/moscow/img/shared/banner.png">
            <div class="imageabs" style="width: 450px;">
                <div class="imagetitle"><?=$banner_out?></div>
                                ...
                                <div class="container">
                                    <ul class="popularlist">
                                      <?php foreach ($brands as $brand) { ?>
                                        <li style="line-height: 25px"><a href="/<?=mb_strtolower($brand)?>/"><?=$brand?></a></li>
                                      <?php } ?>
                                    </ul>
                                </div>
                            </div>
                              ...
                              <? $i =0;
                                 foreach ($addresis as $value):
                                  ...
                                  <div class="contacttable panel">
                                        ...
                                        <? if ($i): ?>
                                         ...
                                         <div class="contacttitle collapsed" data-toggle="collapse"
                                            ...
                                            <div class="collapse" id="cnt-<?=$i?>">
                                                <p><a href="http://<?=$urlSite?><?=($url)?>"><?=$address?></a><br />
                                        ...
                                        <? endif; ?>
                                            <?=tools::format_phone($value['phone'])?></p>
                                        </div>
                                  </div>
                              <?  $i++;
                                 endforeach; ?>
