    ...
    <div class="imagerow ir-small-margin">
            <div class="container">
                <div class="imagerel">
                    ...
                    <? endif; ?>
                    <div class="imageabs<?=(($banner_right) ? ' imageabs-right' : '')?>">
                        <div class="imagetitle">
                            Закажите ремонт со <span>скидкой 10%</span>
                        </div>
                        <div class="imagetext">
                            Записываясь на ремонт любой техники<?=(!in_array($url, ['/o_nas/', '/kontakty/', '/vakansii/', '/dostavka/']) ? ' '.$marka : '')?> в нашем сервисе в этом месяце, вы получаете скидку на все услуги
                        </div>
                        <div class="brand-ask">
