                   ...
                   <li itemprop="name"><a href="/" itemprop="url">Главная</a></li>  
                        <li class="breadcrumbs-inside-drop">
                            ...
                            <ul class="drop">
                                ...
                                <li itemprop="name"><a itemprop="url" href="/info/time-to-repair/">Время работ</a></li>
                            </ul>
                        </li>
                    <li itemprop="name"><span>Срочные работы</span></li>
                </ul>
            </div>
        </div>
    </section>
                ...
                <div class="block-list">
                    ...
                    <div class="block block-text">
                        <div class="block-inside">
                            <p><?=$description_hot_work?></p>
                        </div>
                    </div>
                    <div class="block block-table block-service-table">
                        <div class="block-inside">
                            <h2>Популярные виды проводимых работ <?=$marka?></h2>
