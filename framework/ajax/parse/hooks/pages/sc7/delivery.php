...
$predlojenie = array();
$predlojenie[] = array('<p>Выезд и доставка осуществляется при любом количестве');
$predlojenie[] = array("сдаваемых устройств","сдаваемой техники");
$predlojenie[] = array("в городе ".$region_name.".");
$predlojenie[] = array("Услуга приёма и доставки на дом направлена на то, чтобы экономить время клиентов. Ведь вы можете заниматься действительно важными делами, пока сервис центр ремонтирует");
$predlojenie[] = array('ваше изделие.</p>','ваш аппарат.</p>','ваше устройство.</p>');
$predlojenie[] = array('<p>К вам приедет');
$predlojenie[] = array("курьер,");
$predlojenie[] = array("который предварительно определит, какой ремонт необходим изделию. Если же понадобится консультация мастера, то с ним можно будет связаться по телефону, указанному");
$predlojenie[] = array("бланке","листе");
$predlojenie[] = array("приёмки, и быстро получить качественный ответ относительно");
$predlojenie[] = array("восстановления","ремонта","починки","оживления");
$predlojenie[] = array('аппарата.</p>');
