...
$centr[2][] = array(
    ...
    $centr[3][] = array(
    tools::declOfNum($centr_3, array("Отремонтированый<span>плоттер", "Отремонтированных<span>плоттера", "Отремонтированных<span>плоттеров"),false),
    tools::declOfNum($centr_3, array("Плоттер<span>отремонтирован", "Плоттера<span>отремонтировано", "Плоттеров<span>отремонтировали"),false)
                      ...
                      <div class="item">
                        <div class="articles-info">
                            <div class="articles-title">
                                <a href="/remont-plotterov-<?=strtolower($data['brand_name'])?>/">Ремонт плоттеров <?=$data['brand_name']?></a>
                            </div>
                            <div class="articles-text"></div>
                            <div class="articles-price">от <?=rand(11,17)*100+(rand(0,1)*50)+(rand(0,1)*99)?> руб</div>
                            <a class="btn btn-link" href="/remont-plotterov-<?=strtolower($data['brand_name'])?>/">Подробнее</a>
                        </div>
                        <div class="articles-image" style="margin: 10px auto;">
                            <a href="/remont-plotterov-<?=strtolower($data['brand_name'])?>/">
                            <img src="/images/hab/<?=strtolower($data['brand_name'])?>/plotter.png">
                            </a>
                        </div>
                    </div>
					<? } ?>
