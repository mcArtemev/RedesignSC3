...
require_once (__DIR__.'/text/getGadgetsData.php');
}
            ...
            <div class="content-block">
                ...
                <div class="content-block__bottom">
                    ...
                    <div class="info-block">
                        ...
                        {
                            // if(!empty($info_block[$devices['type']]['services'])){
                            if(!empty(getGadgetsData($marka,$devices['type'])['services'])){
                        ...
                        <? 
                                ...
                                // echo $info_block[$accord[$devices['type']]][0];
                                echo getGadgetsData($marka,$devices['type'])['services'];
                            }
                        }
