...
?>
        ...
        <section class="hello">
            ...
            <div class="fixed">
                <h1><?=$this->_ret['h1']?></h1>
        <?php   if (file_exists("/var/www/www-root/data/www/sc2/userfiles/site/large/".$marka_lower."-centre".$header_1.".png")) :?>
        ...
        <?php    else: ?>
                    <div class="hello__photo"><img src="/img/alt/main.png" width="415" height="221" alt="<?=$servicename?> - сервисный центр <?=$ru_marka?>" title="<?=$servicename?> - сервисный центр <?=$ru_marka?>"></div>
        <?php   endif; ?> 
                ...
                <div class="hello__info">
                    ...
                    <?else:?>
                        ...
                        <p>С нами вы получите не только профессиональный ремонт, но и первоклассный сервис, включая экспресс диагностику и срочный ремонт.</p>
                        <p>Ждем вас!</p>
                        <!--noindex--><a href="<?=$multiMirrorLink?>/order/"  class="btn btn--fill">Записаться на ремонт</a><!--/noindex-->
                    <?endif;?>
                </div>
            ...
            <div class="wrapper lgray">
                ...
                <div class="fixed">
                   ...
                   // var_dump($this->_datas['all_devices']);
                    ...
                    {
                        if(!empty($accord_image[$device['type']])){
                        $name = tools::mb_ucfirst($device['type'], 'utf-8', false);

                        $str = '<a href="'.$multiMirrorLink.'/'.$accord[$device['type']].'/" class="experts-item-link">
                            <div class="experts-item container">
                                <div class="half">';
                                if (file_exists("/var/www/www-root/data/www/sc2/userfiles/clauses/large/".$accord_image[$device['type']]."-".$marka_lower.".png")) {
        ...
        //     if ($this->_datas['query'] == 'admin'){
        //         $ol=explode('=',$this->_datas['query']);
        //         var_dump($ol);
        //     var_dump($this->_datas[$ol[1]]);
        // }
        
        if(!empty($this->_datas['typeList'])):?>
        <section class="experts">

            <div class="wrapper lgray">
            
                <div class="fixed">
                    <span class="h2">Другие устройства <?=$marka?></span>
                    <ul class='othersType'>
        <?php       
          
                foreach ($this->_datas['typeList'] as $device)
                    {
                        echo '<li><a href="'.$multiMirrorLink.'/'.$device.'/" class="experts-item-link ">'.tools::mb_ucfirst($this->_datas['add_device_type'][$device]['type_m'], 'utf-8', false).'</a></li>';
                    
                    }
                    // var_dump($this->_datas['typeList']);
        ?>
                    </ul>
                </div>
        ...
        <div class="fixed">
         <div class="block-new">
             ...
             <div class="pref">
                ...
                <?else:?>
                    <a href="<?=$multiMirrorLink?>diagnostics/">Тестирование за 15 минут</a>
