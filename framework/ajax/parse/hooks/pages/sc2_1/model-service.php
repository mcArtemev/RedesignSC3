...
<div class="content-block">
    ...
    <? if ($this->_mode == 1): ?>
        <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="/servis-<?=$marka_lower?>/"><meta itemprop="title" content="Главная"/><img src="/bitrix/templates/centre/img/home.png" alt="home"/></a></span>
        <span> / </span>
    ...
    <? if ($this->_mode == 0): ?>
        <a href="/"><img src="/bitrix/templates/centre/img/home.png" alt="home"/></a>
        <span> / </span>
        <span><?=tools::mb_firstupper($this->_datas['syns'][3])?></span>
    <? endif; ?>
    </section>
    ...
    <div class="content-block__top">
        ...
        <div class="info-block remont-block" itemscope itemtype="http://schema.org/Product">
            ...
            <img itemprop="image" src="http://<?=$this->_datas['site_name']?>/<?=$this->_ret['img']?>"/>
