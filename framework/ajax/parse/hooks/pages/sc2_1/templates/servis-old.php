...
?>
        ...
        <section class="hello">
            ...
            <div class="fixed">
                <h1><?=$this->_ret['h1']?></h1>
                <div class="hello__photo"><amp-img src="/userfiles/site/large/<?=$marka_lower?>-centre<?=$header_1?>.png" width="415" height="221" alt="<?=$servicename?> - сервисный центр <?=$ru_marka?>" title="<?=$servicename?> - сервисный центр <?=$ru_marka?>"></div>
                <div class="hello__info">
                    ...
                    <?else:?>
                        ...
                        <p>С нами вы получите не только профессиональный ремонт, но и первоклассный сервис, включая экспресс диагностику и срочный ремонт.</p>
                        <p>Ждем вас!</p>
                        <!--noindex--><a href="/zakaz/"  class="btn btn--fill">Записаться на ремонт</a><!--/noindex-->
                    <?endif;?>
                </div>
                    ...
                    foreach ($this->_datas['all_devices'] as $device)
                    {
                        ...
                        $str = '<a href="/'.$accord[$device['type']].'/" class="experts-item-link">
                            <div class="experts-item container">
                                <div class="half">
                                    <amp-img src="/userfiles/clauses/large/'.$accord_image[$device['type']].'-'.$marka_lower.'.png" alt="'.$name.'" title="'.$name.'">
                                </div>
                                <div class="half">
                                    <span>'.$name.'</span>';
        ...
        <section class="help">
            <div class="fixed">
                ...
                <amp-img src="/bitrix/templates/centre/img/lady.png" width="289" height="308" alt="<?=$servicename?> - сервисный центр <?=$ru_marka?>" title="<?=$servicename?> - сервисный центр <?=$ru_marka?>">
            </div>
        </section>
