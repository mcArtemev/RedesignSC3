<section class = "hello">
  <div class="fixed">
    ...
    <div class="hello__photo">
            <amp-img src="/bitrix/templates/centre/img/site/large/sony-centre2.png" width="415" height="221" alt="Sony Centre - сервисный центр Сони" title="Sony Centre - сервисный центр Сони" layout="responsive"></amp-img>
    </div>
  ...
  <div class = "wrapper lgray">
    <div class = "fixed">
      ...
      <a href = "/servis-<?=strtolower($marka)?>/" class = "mainBrand">
	    <amp-img src = "/bitrix/templates/centre/img/mainBrand/<?=strtolower($marka)?>.png"  height="221" width="415" layout="responsive"></amp-img>
        <span><?=$marka?></span>
      </a>
      <?php } ?>
    </div>
