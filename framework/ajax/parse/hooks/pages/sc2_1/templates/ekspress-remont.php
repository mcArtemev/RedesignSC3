...
$express2 = array("Срочное и квалифицированное обслуживание – это то, на что может рассчитывать любой обладатель устройства. В $servicename знают о качестве все, но теперь это еще и вопрос времени.",
...
$expeditious_service = array("Мы знаем, что персональные устройства уже стали неотъемлемой частью жизни своих владельцев, и обходиться без них длительное время некомфортно. Поэтому в $ru_servicename мы не теряем ни минуты, и осуществляем ремонт именно в те сроки, в которые он должен быть выполнен.");
            ...
            <div class="content-block">
                ...
                <div class="content-block__top">
                    ...
                    <div class="info-block">
                        ...
                        <amp-img src="/bitrix/templates/centre/img/site/large/ekspress-remont.jpg" width="350" height="110" alt="Экспресс ремонт" title="Экспресс ремонт">
                ...
                <div class="content-block__bottom">
                    ...
                    <div class="info-block">
                        ...
                        <?=$expeditious_service_a?>
                        <p><amp-img src="/bitrix/templates/centre/img/site/large/services-2.jpg" alt="" title="" width="705" height="200"></p>
