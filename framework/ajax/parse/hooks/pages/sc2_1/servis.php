...
?>
        ...
        <section class="hello">
            ...
            <div class="fixed">
                <h1><?=$this->_ret['h1']?></h1>
                <div class="hello__photo"><img src = "/bitrix/templates/centre/img/mainBrand/<?=strtolower($marka)?>.png" width="415" height="221" alt="Виды электроники <?=$ru_marka?> обслуживаемые нашими инженерами"></div>
                    ...
                    foreach ($this->_datas['all_devices'] as $device)
                    {
                        ...
                        $str = '<a href="/'.$accord[$device['type']].'/" class="experts-item-link">
                            <div class="experts-item container">
                                <div class="half">
                                    <img src="/bitrix/templates/centre/img/large/'.$accord_image[$device['type']].'-'.$marka_lower.'.png" alt="'.$name.'" title="'.$name.'">
                                </div>
                                <div class="half">
                                    <span>'.$name.'</span>';
        ...
        <section class="help">
            <div class="fixed">
                ...
                <?endif;?>
                <?php } ?>
                <img src="/bitrix/templates/centre/img/lady.png" width="289" height="308" alt="Опытный сотрудник контакт-центра ответит на ваши вопросы">
            </div>
        </section>
