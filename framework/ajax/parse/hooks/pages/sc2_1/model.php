...
<div class="content-block">
  ...
  <? if ($this->_mode == -3): ?>
      <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="/servis-<?=$marka_lower?>/"><span itemprop="title"><?php if ($this->_datas['marka']['name'] == 'Sony') { ?>Cервис Cони <?php } else { $this->_datas['marka']['name']; }?></span></a></span>
      <span> / </span>
  ...
  <div class="content-block__bottom">
      <div class="info-block">
          ...
          <?=str_replace("Sony Centre","CENTRE",$this->_datas['vars4']);?>
