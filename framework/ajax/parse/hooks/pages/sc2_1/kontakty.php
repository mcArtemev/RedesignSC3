          ...
          <div class="content-block content-block--contacts">
            ...
            <div class="content-block__top">
                <div class="info-block">
                    ...
                    <img src="/bitrix/templates/centre/img/site/large/kontakty.jpg" width="350" height="110" alt="Контакты" title="Контакты">
            ...
            <div class="divider divider--three"></div>
              ...
              <div class="content-block__bottom">
                    ...
                    <div class="info-block">
                        ...
                        <div style="width: 100%; height: 300px; background-image: url('https://static-maps.yandex.ru/1.x/?ll=<?=$this->_datas['partner']['y']?>,<?=$this->_datas['partner']['x']?>&size=600,450&z=13&l=map&pt=<?=$this->_datas['partner']['y']?>,<?=$this->_datas['partner']['x']?>,org'); background-repeat: no-repeat; background-attachment: scroll; background-position-y: center; background-size: cover;"></div>
