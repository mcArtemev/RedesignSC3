        ...
        <section class="fixed content-wrapper">
            <div class="content-block">
                ...
                <section class="crumbs">
                    <span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="/servis-<?=$marka_lower?>/"><span itemprop="title"><?php if ($this->_datas['marka']['name']) { ?>Cервис Сони <?php } else { echo $this->_datas['marka']['name']; } ?></span></a></span>
                    <span> / </span>
                    <span>Диагностика <?=$marka?></span>
                </section>
                ...
                <div class="content-block__top">
                    ...
                    <div class="info-block">
                        ...
                        <img src="/bitrix/templates/centre/img/site/large/diagnostika.jpg" width="350" height="110" alt="Диагностика" title="Диагностика">
                ...
                <div class="content-block__bottom">
                    ...
                    <div class="info-block">
                        ...
                        <p><span class="h2"><span>Бесплатно в <?php if ($marka == 'Sony') { ?>CENTRE <?php } else { echo $servicename; } ?></span></span></p>
                        ...
                        <?=$diagnostics4_a?>
                        <p><img src="/bitrix/templates/centre/img/site/large/diagnostics-2.jpg" alt="" title="" width="705" height="200"></p>
